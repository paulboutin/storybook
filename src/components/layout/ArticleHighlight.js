...
const ArticleHighlight = ({
  ...
  return (
    <Hero type='spaced' image={image} className='article-highlight'>
      <a href={href} className='article-highlight-wrapper'>
        <div className='article-highlight-container container'>
          {eyebrow.enable && (
            <Eyebrow className='white'>{eyebrow.text}</Eyebrow>
          )}
          ...
          <div className='article-highlight-subtext'>
            {subtext}
            <i className='icon icon-long-arrow-right text-xs' />
          </div>
        </div>
      </a>
    </Hero>
