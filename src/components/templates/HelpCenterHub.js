    ...
    articles: [
      {
        ...
        content: (
          <>
            ...
            1-800-488-2265, option 3 (TTY 1-800-659-5495). If you're outside the
            U.S., call 1-925-975-3202; before the "1," be sure to use any
...
const HelpCenterHub = ({ topics = defaultTopics }) => {
  return (
    <>
      <Navigation />
